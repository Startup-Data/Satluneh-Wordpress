...
if ( ! function_exists( 'ot_display_by_type' ) ) {
	...
	function ot_display_by_type( $args = array() ) {
		...
		if ( function_exists( $function_name_by_type ) ) {
			...
			echo '<p>' . __( 'Sorry, this function does not exist', 'pe-terraclassic' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_background' ) ) {
	...
	function ot_type_background( $args = array() ) {
		...
		if ( in_array( 'background-repeat', $ot_recognized_background_fields ) ) {
			...
			echo '<option value="">' . __( 'background-repeat', 'pe-terraclassic' ) . '</option>';
		...
		if ( in_array( 'background-attachment', $ot_recognized_background_fields ) ) {
			...
			echo '<option value="">' . __( 'background-attachment', 'pe-terraclassic' ) . '</option>';
		...
		if ( in_array( 'background-position', $ot_recognized_background_fields ) ) {
			...
			echo '<option value="">' . __( 'background-position', 'pe-terraclassic' ) . '</option>';
		...
		if ( in_array( 'background-size', $ot_recognized_background_fields ) ) {
			...
			if ( is_array( $choices ) && ! empty( $choices ) ) {
				...
				echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat ot-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-size', 'pe-terraclassic' ) . '" />';
		...
		if ( in_array( 'background-image', $ot_recognized_background_fields ) ) {
			...
			/* input */
			echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-image]" id="' . esc_attr( $field_id ) . '" value="' . ( isset( $field_value['background-image'] ) ? esc_attr( $field_value['background-image'] ) : '' ) . '" class="widefat option-tree-ui-upload-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-image', 'pe-terraclassic' ) . '" />';

			/* add media button */
			echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add Media', 'pe-terraclassic' ) . '"><span class="icon ot-icon-plus-circle"></span>' . __( 'Add Media', 'pe-terraclassic' ) . '</a>';
			...
			if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
				...
				echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . __( 'Remove Media', 'pe-terraclassic' ) . '"><span class="icon ot-icon-minus-circle"></span>' . __( 'Remove Media', 'pe-terraclassic' ) . '</a>';
...
if ( ! function_exists( 'ot_type_border' ) ) {
	...
	function ot_type_border( $args = array() ) {
		...
		if ( in_array( 'width', $ot_recognized_border_fields ) ) {
			...
			echo '<div class="ot-option-group ot-option-group--one-sixth"><input type="text" name="' . esc_attr( $field_name ) . '[width]" id="' . esc_attr( $field_id ) . '-width" value="' . esc_attr( $width ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'width', 'pe-terraclassic' ) . '" /></div>';
		...
		if ( in_array( 'unit', $ot_recognized_border_fields ) ) {
			...
			echo '<option value="">' . __( 'unit', 'pe-terraclassic' ) . '</option>';
		...
		if ( in_array( 'style', $ot_recognized_border_fields ) ) {
			...
			echo '<option value="">' . __( 'style', 'pe-terraclassic' ) . '</option>';
...
if ( ! function_exists( 'ot_type_category_checkbox' ) ) {
	...
	function ot_type_category_checkbox( $args = array() ) {
		...
		if ( ! empty( $categories ) ) {
			...
			echo '<p>' . __( 'No Categories Found', 'pe-terraclassic' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_category_select' ) ) {
	...
	function ot_type_category_select( $args = array() ) {
		...
		/* has cats */
		if ( ! empty( $categories ) ) {
			echo '<option value="">-- ' . __( 'Choose One', 'pe-terraclassic' ) . ' --</option>';
			foreach ( $categories as $category ) {
				echo '<option value="' . esc_attr( $category->term_id ) . '"' . selected( $field_value, $category->term_id, false ) . '>' . esc_attr( $category->name ) . '</option>';
			}
		} else {
			echo '<option value="">' . __( 'No Categories Found', 'pe-terraclassic' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_custom_post_type_checkbox' ) ) {
	...
	function ot_type_custom_post_type_checkbox( $args = array() ) {
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<p>' . __( 'No Posts Found', 'pe-terraclassic' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_custom_post_type_select' ) ) {
	...
	function ot_type_custom_post_type_select( $args = array() ) {
		...
		/* query posts array */
		$my_posts = get_posts( apply_filters( 'ot_type_custom_post_type_select_query', array(
			'post_type'      => $post_type,
			'posts_per_page' => - 1,
			'orderby'        => 'title',
			'order'          => 'ASC',
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<option value="">' . __( 'No Posts Found', 'pe-terraclassic' ) . '</option>';
		}
	...
	function ot_type_gallery( $args = array() ) {
		...
		if ( ! empty( $ids ) ) {
          ...
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . __( 'Delete Gallery', 'pe-terraclassic' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'Edit Gallery', 'pe-terraclassic' ) . '</a>
          </div>';
			...
			echo '
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'Create Gallery', 'pe-terraclassic' ) . '</a>
          </div>';
...
if ( ! function_exists( 'ot_type_google_fonts' ) ) {
	...
	function ot_type_google_fonts( $args = array() ) {
		...
		foreach ( $field_value as $key => $value ) {
			...
			echo '<a href="javascript:void(0);" class="js-remove-google-font option-tree-ui-button button button-secondary light" title="' . __( 'Remove Google Font', 'pe-terraclassic' ) . '"><span class="icon ot-icon-minus-circle"/>' . __( 'Remove Google Font', 'pe-terraclassic' ) . '</a>';
		...
		echo '<a href="javascript:void(0);" class="js-add-google-font option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add Google Font', 'pe-terraclassic' ) . '">' . __( 'Add Google Font', 'pe-terraclassic' ) . '</a>';
...
if ( ! function_exists( 'ot_type_link_color' ) ) {
	...
	function ot_type_link_color( $args = array() ) {
		...
		$ot_recognized_link_color_fields = apply_filters( 'ot_recognized_link_color_fields', array(
			'link'    => _x( 'Standard', 'color picker', 'pe-terraclassic' ),
			'hover'   => _x( 'Hover', 'color picker', 'pe-terraclassic' ),
			'active'  => _x( 'Active', 'color picker', 'pe-terraclassic' ),
			'visited' => _x( 'Visited', 'color picker', 'pe-terraclassic' ),
			'focus'   => _x( 'Focus', 'color picker', 'pe-terraclassic' )
		), $field_id );
...
if ( ! function_exists( 'ot_type_list_item' ) ) {
	...
	function ot_type_list_item( $args = array() ) {
		...
		/* button */
		echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add New', 'pe-terraclassic' ) . '">' . __( 'Add New', 'pe-terraclassic' ) . '</a>';

		/* description */
		$list_desc = $sortable ? __( 'You can re-order with drag & drop, the order will update after saving.', 'pe-terraclassic' ) : '';
	...
	function ot_type_on_off( $args = array() ) {
		...
		$field_choices = array(
			array(
				 ...
				 */
				'label' => apply_filters( 'ot_on_off_switch_on_label', __( 'On', 'pe-terraclassic' ), $field_id, 'on' )
			),
			array(
				/**
				 ...
				 * @param string $filter_id For filtering both on/off label with one function.
				 */
				'label' => apply_filters( 'ot_on_off_switch_off_label', __( 'Off', 'pe-terraclassic' ), $field_id, 'off' )
			)
		);
...
if ( ! function_exists( 'ot_type_page_checkbox' ) ) {
	...
	function ot_type_page_checkbox( $args = array() ) {
		...
		/* query pages array */
		$my_posts = get_posts( apply_filters( 'ot_type_page_checkbox_query', array(
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<p>' . __( 'No Pages Found', 'pe-terraclassic' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_page_select' ) ) {
	...
	function ot_type_page_select( $args = array() ) {
		...
		/* query pages array */
		$my_posts = get_posts( apply_filters( 'ot_type_page_select_query', array(
			'post_type'      => array( 'page' ),
			'posts_per_page' => - 1,
			'orderby'        => 'title',
			'order'          => 'ASC',
		...
		if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
			...
			echo '<option value="">' . __( 'No Pages Found', 'pe-terraclassic' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_post_checkbox' ) ) {
	...
	function ot_type_post_checkbox( $args = array() ) {
		...
		/* query posts array */
		$my_posts = get_posts( apply_filters( 'ot_type_post_checkbox_query', array(
...
if ( ! function_exists( 'ot_type_post_select' ) ) {
	...
	function ot_type_post_select( $args = array() ) {
		...
		/* query posts array */
		$my_posts = get_posts( apply_filters( 'ot_type_post_select_query', array(
			'post_type'      => array( 'post' ),
			'posts_per_page' => - 1,
			'orderby'        => 'title',
			'order'          => 'ASC',
...
if ( ! function_exists( 'ot_type_sidebar_select' ) ) {
	...
	function ot_type_sidebar_select( $args = array() ) {
		...
		/* has sidebars */
		if ( count( $sidebars ) ) {
			echo '<option value="">-- ' . __( 'Choose Sidebar', 'pe-terraclassic' ) . ' --</option>';
			foreach ( $sidebars as $id => $sidebar ) {
				echo '<option value="' . esc_attr( $id ) . '"' . selected( $field_value, $id, false ) . '>' . esc_attr( $sidebar ) . '</option>';
			}
		} else {
			echo '<option value="">' . __( 'No Sidebars', 'pe-terraclassic' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_slider' ) ) {
	...
	function ot_type_slider( $args = array() ) {
		...
		/* description */
		echo '<div class="list-item-description">' . __( 'You can re-order with drag & drop, the order will update after saving.', 'pe-terraclassic' ) . '</div>';
	...
	function ot_type_social_links( $args = array() ) {
		...
		if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
			...
			$field_value = apply_filters( 'ot_type_social_links_defaults', array(
				array(
					'name'  => __( 'Facebook', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Twitter', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Google+', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'LinkedIn', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Pinterest', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Youtube', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Dribbble', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Github', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Forrst', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Digg', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Delicious', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Tumblr', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Skype', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'SoundCloud', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Vimeo', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'Flickr', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				),
				array(
					'name'  => __( 'VK.com', 'pe-terraclassic' ),
					'title' => '',
					'href'  => ''
				)
			), $field_id );
		...
		/* button */
		echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add New', 'pe-terraclassic' ) . '">' . __( 'Add New', 'pe-terraclassic' ) . '</a>';

		/* description */
		echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'pe-terraclassic' ), $field_id ) . '</div>';
...
if ( ! function_exists( 'ot_type_spacing' ) ) {
	...
	function ot_type_spacing( $args = array() ) {
		...
		if ( in_array( 'top', $ot_recognized_spacing_fields ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-up ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[top]" id="' . esc_attr( $field_id ) . '-top" value="' . $top . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'top', 'pe-terraclassic' ) . '" /></div>';
		...
		if ( in_array( 'right', $ot_recognized_spacing_fields ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-right ot-option-group--icon"></span></span><input type="text" name="' . esc_attr( $field_name ) . '[right]" id="' . esc_attr( $field_id ) . '-right" value="' . $right . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'right', 'pe-terraclassic' ) . '" /></div>';
		...
		if ( in_array( 'bottom', $ot_recognized_spacing_fields ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-down ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[bottom]" id="' . esc_attr( $field_id ) . '-bottom" value="' . $bottom . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'bottom', 'pe-terraclassic' ) . '" /></div>';
		...
		if ( in_array( 'left', $ot_recognized_spacing_fields ) ) {
			...
			echo '<div class="ot-option-group"><span class="ot-icon-arrow-left ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[left]" id="' . esc_attr( $field_id ) . '-left" value="' . $left . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'left', 'pe-terraclassic' ) . '" /></div>';
...
if ( ! function_exists( 'ot_type_tag_checkbox' ) ) {
	...
	function ot_type_tag_checkbox( $args = array() ) {
		...
		if ( $tags ) {
			...
			echo '<p>' . __( 'No Tags Found', 'pe-terraclassic' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_tag_select' ) ) {
	...
	function ot_type_tag_select( $args = array() ) {
		...
		if ( $tags ) {
			...
			echo '<option value="">' . __( 'No Tags Found', 'pe-terraclassic' ) . '</option>';
		}
...
if ( ! function_exists( 'ot_type_taxonomy_checkbox' ) ) {
	...
	function ot_type_taxonomy_checkbox( $args = array() ) {
		...
		/* get taxonomies */
		$taxonomies = get_categories( apply_filters( 'ot_type_taxonomy_checkbox_query', array(
			'hide_empty' => false,
			'taxonomy'   => $taxonomy
		), $field_id ) );
		...
		if ( $taxonomies ) {
			...
			echo '<p>' . __( 'No Taxonomies Found', 'pe-terraclassic' ) . '</p>';
		}
...
if ( ! function_exists( 'ot_type_taxonomy_select' ) ) {
	...
	function ot_type_taxonomy_select( $args = array() ) {
		...
		/* get taxonomies */
		$taxonomies = get_categories( apply_filters( 'ot_type_taxonomy_select_query', array(
			'hide_empty' => false,
			'taxonomy'   => $taxonomy
		), $field_id ) );
		...
		if ( $taxonomies ) {
			...
			echo '<option value="">' . __( 'No Taxonomies Found', 'pe-terraclassic' ) . '</option>';
		}
