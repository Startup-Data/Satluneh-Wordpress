					...
					array(
						...
						'pages' => array(
							array(
								...
								'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'pe-terraclassic' ) ),
								'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Options', 'pe-terraclassic' ) ),
								...
								'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme Options updated.', 'pe-terraclassic' ) ),
								'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme Options reset.', 'pe-terraclassic' ) ),
								'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Save Changes', 'pe-terraclassic' ) ),
	...
	function ot_register_settings_page() {
		...
		if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
			...
			function ot_has_custom_theme_options() {
				...
				echo '<div class="error"><p>' . __( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'pe-terraclassic' ) . '</p></div>';
		...
		$ot_register_pages_array = array(
			array(
				'id'          => 'ot',
				'page_title'  => __( 'OptionTree', 'pe-terraclassic' ),
				'menu_title'  => __( 'OptionTree', 'pe-terraclassic' ),
			...
			array(
				...
				'page_title'      => __( 'Settings', 'pe-terraclassic' ),
				'menu_title'      => __( 'Settings', 'pe-terraclassic' ),
				'capability'      => 'edit_theme_options',
				'menu_slug'       => 'ot-settings',
				'icon_url'        => null,
				'position'        => null,
				'updated_message' => __( 'Theme Options updated.', 'pe-terraclassic' ),
				'reset_message'   => __( 'Theme Options reset.', 'pe-terraclassic' ),
				'button_text'     => __( 'Save Settings', 'pe-terraclassic' ),
				'show_buttons'    => false,
				'sections'        => array(
					array(
						'id'    => 'create_setting',
						'title' => __( 'Theme Options UI', 'pe-terraclassic' )
					),
					array(
						'id'    => 'import',
						'title' => __( 'Import', 'pe-terraclassic' )
					),
					array(
						'id'    => 'export',
						'title' => __( 'Export', 'pe-terraclassic' )
					),
					array(
						'id'    => 'layouts',
						'title' => __( 'Layouts', 'pe-terraclassic' )
					)
				),
				'settings'        => array(
					array(
						'id'      => 'theme_options_ui_text',
						'label'   => __( 'Theme Options UI Builder', 'pe-terraclassic' ),
						'type'    => 'theme_options_ui',
						'section' => 'create_setting'
					),
					array(
						'id'      => 'import_xml_text',
						'label'   => __( 'Settings XML', 'pe-terraclassic' ),
						'type'    => 'import-xml',
						'section' => 'import'
					),
					array(
						'id'      => 'import_settings_text',
						'label'   => __( 'Settings', 'pe-terraclassic' ),
						'type'    => 'import-settings',
						'section' => 'import'
					),
					array(
						'id'      => 'import_data_text',
						'label'   => __( 'Theme Options', 'pe-terraclassic' ),
						'type'    => 'import-data',
						'section' => 'import'
					),
					array(
						'id'      => 'import_layouts_text',
						'label'   => __( 'Layouts', 'pe-terraclassic' ),
						'type'    => 'import-layouts',
						'section' => 'import'
					),
					array(
						'id'      => 'export_settings_file_text',
						'label'   => __( 'Settings PHP File', 'pe-terraclassic' ),
					...
					array(
						...
						'label'   => __( 'Layout Management', 'pe-terraclassic' ),
						'type'    => 'modify-layouts',
						'section' => 'layouts'
					)
				)
			...
			array(
				'id'              => 'documentation',
				'parent_slug'     => 'ot-settings',
				'page_title'      => __( 'Documentation', 'pe-terraclassic' ),
				'menu_title'      => __( 'Documentation', 'pe-terraclassic' ),
				'capability'      => 'edit_theme_options',
				...
				'sections'        => array(
					array(
						'id'    => 'creating_options',
						'title' => __( 'Creating Options', 'pe-terraclassic' )
					),
					array(
						'id'    => 'option_types',
						'title' => __( 'Option Types', 'pe-terraclassic' )
					),
					array(
						'id'    => 'functions',
						'title' => __( 'Function References', 'pe-terraclassic' )
					),
					array(
						'id'    => 'theme_mode',
						'title' => __( 'Theme Mode', 'pe-terraclassic' )
					),
					array(
						'id'    => 'meta_boxes',
						'title' => __( 'Meta Boxes', 'pe-terraclassic' )
					),
					array(
						'id'    => 'examples',
						'title' => __( 'Code Examples', 'pe-terraclassic' )
					),
					array(
						'id'    => 'layouts_overview',
						'title' => __( 'Layouts Overview', 'pe-terraclassic' )
					)
				),
				'settings'        => array(
					array(
						'id'      => 'creating_options_text',
						'label'   => __( 'Overview of available Theme Option fields.', 'pe-terraclassic' ),
						'type'    => 'creating-options',
						'section' => 'creating_options'
					),
					array(
						'id'      => 'option_types_text',
						'label'   => __( 'Option types in alphabetical order & hooks to filter them.', 'pe-terraclassic' ),
						'type'    => 'option-types',
						'section' => 'option_types'
					),
					array(
						'id'      => 'functions_ot_get_option',
						'label'   => __( 'Function Reference:ot_get_option()', 'pe-terraclassic' ),
						'type'    => 'ot-get-option',
						'section' => 'functions'
					),
					array(
						'id'      => 'functions_get_option_tree',
						'label'   => __( 'Function Reference:get_option_tree()', 'pe-terraclassic' ),
						'type'    => 'get-option-tree',
						'section' => 'functions'
					),
					array(
						'id'      => 'theme_mode_text',
						'label'   => __( 'Theme Mode', 'pe-terraclassic' ),
						'type'    => 'theme-mode',
						'section' => 'theme_mode'
					),
					array(
						'id'      => 'meta_boxes_text',
						'label'   => __( 'Meta Boxes', 'pe-terraclassic' ),
						'type'    => 'meta-boxes',
						'section' => 'meta_boxes'
					),
					array(
						'id'      => 'example_text',
						'label'   => __( 'Code examples for front-end development.', 'pe-terraclassic' ),
						'type'    => 'examples',
						'section' => 'examples'
					),
					array(
						'id'      => 'layouts_overview_text',
						'label'   => __( 'What\'s a layout anyhow?', 'pe-terraclassic' ),
		...
		foreach ( $ot_register_pages_array as $key => $page ) {
			...
			if ( $page['id'] == 'settings' ) {
				...
				if ( OT_SHOW_SETTINGS_IMPORT == false ) {
					...
					foreach ( $page['settings'] as $setting_key => $setting ) {
						if ( $setting['section'] == 'import' && in_array( $setting['id'], array(
								'import_xml_text',
				...
				if ( OT_SHOW_SETTINGS_EXPORT == false ) {
					...
					foreach ( $page['settings'] as $setting_key => $setting ) {
						if ( $setting['section'] == 'export' && in_array( $setting['id'], array(
								'export_settings_file_text',
								'export_settings_text'
							) )
						) {
							unset( $ot_register_pages_array[ $key ]['settings'][ $setting_key ] );
						}
		...
		if ( 'background' == $type ) {
			...
			foreach ( $input as $key => $value ) {
				...
				if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
					...
					add_settings_error( 'pe-terraclassic', 'invalid_border_width', sprintf( __( 'The %s input field for %s only allows numeric values.', 'pe-terraclassic' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
			...
			if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
				...
				add_settings_error( 'pe-terraclassic', 'invalid_hex', sprintf( __( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'pe-terraclassic' ), '<code>' . $field_id . '</code>' ), 'error' );
			...
			if ( isset( $errors ) ) {
				...
				foreach ( $errors as $error ) {
					...
					add_settings_error( 'pe-terraclassic', 'invalid_dimension_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'pe-terraclassic' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
			...
			if ( isset( $errors ) ) {
				...
				foreach ( $errors as $error ) {
					...
					add_settings_error( 'pe-terraclassic', 'invalid_spacing_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'pe-terraclassic' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
	...
	function ot_admin_scripts() {
		...
		$localized_array = array(
			...
			'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'pe-terraclassic' ) ),
			'remove_media_text'     => __( 'Remove Media', 'pe-terraclassic' ),
			'reset_agree'           => __( 'Are you sure you want to reset back to the defaults?', 'pe-terraclassic' ),
			'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'pe-terraclassic' ),
			'remove_agree'          => __( 'Are you sure you want to remove this?', 'pe-terraclassic' ),
			'activate_layout_agree' => __( 'Are you sure you want to activate this layout?', 'pe-terraclassic' ),
			'setting_limit'         => __( 'Sorry, you can\'t have settings three levels deep.', 'pe-terraclassic' ),
			'delete'                => __( 'Delete Gallery', 'pe-terraclassic' ),
			'edit'                  => __( 'Edit Gallery', 'pe-terraclassic' ),
			'create'                => __( 'Create Gallery', 'pe-terraclassic' ),
			'confirm'               => __( 'Are you sure you want to delete this Gallery?', 'pe-terraclassic' ),
			'date_current'          => __( 'Today', 'pe-terraclassic' ),
			'date_time_current'     => __( 'Now', 'pe-terraclassic' ),
			'date_close'            => __( 'Close', 'pe-terraclassic' ),
			'replace'               => __( 'Featured Image', 'pe-terraclassic' ),
			'with'                  => __( 'Image', 'pe-terraclassic' )
		);
...
if ( ! function_exists( 'ot_get_media_post_ID' ) ) {
	...
	function ot_get_media_post_ID() {
		...
		if ( $post_ID === false || empty( $post_ID ) ) {
			...
			// Get the media post ID
			$post_ID = $wpdb->get_var( "SELECT ID FROM $wpdb->posts WHERE `post_title` = 'Media' AND `post_type` = 'pe-terraclassic' AND `post_status` = 'private'" );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
	...
	function ot_create_media_post() {
		...
		$regsiter_post_type( 'pe-terraclassic', array(
			'labels'              => array( 'name' => __( 'Option Tree', 'pe-terraclassic' ) ),
			'public'              => false,
			'show_ui'             => false,
			...
			if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
				...
				$settings = array(
					'sections' => array(
						array(
							'id'    => 'general',
							'title' => __( 'General', 'pe-terraclassic' )
						)
					),
					'settings' => array(
						array(
							'id'        => 'sample_text',
							'label'     => __( 'Sample Text Field Label', 'pe-terraclassic' ),
							'desc'      => __( 'Description for the sample text field.', 'pe-terraclassic' ),
							'section'   => 'general',
							'type'      => 'text',
							'std'       => '',
							'class'     => '',
	...
	function ot_modify_layouts() {
		...
		if ( isset( $_POST['option_tree_modify_layouts_nonce'] ) && wp_verify_nonce( $_POST['option_tree_modify_layouts_nonce'], 'option_tree_modify_layouts_form' ) ) {
			...
			if ( isset( $_REQUEST['page'] ) && $_REQUEST['page'] == apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ) ) {
				$query_args = esc_url_raw( add_query_arg( array( 'settings-updated' => 'layout' ), remove_query_arg( array(
					'action',
					'message'
				), $_POST['_wp_http_referer'] ) ) );
			} else {
				$query_args = esc_url_raw( add_query_arg( array(
					'action'  => 'save-layouts',
					'message' => $message
				), $_POST['_wp_http_referer'] ) );
			}
	...
	function ot_alert_message( $page = array() ) {
		...
		if ( $action == 'save-settings' ) {
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings updated.', 'pe-terraclassic' ) . '</p></div>';

			} else if ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be saved.', 'pe-terraclassic' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings Imported.', 'pe-terraclassic' ) . '</p></div>';

			} else if ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be imported.', 'pe-terraclassic' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Data Imported.', 'pe-terraclassic' ) . '</p></div>';

			} else if ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Data could not be imported.', 'pe-terraclassic' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Imported.', 'pe-terraclassic' ) . '</p></div>';

			} else if ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be imported.', 'pe-terraclassic' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Updated.', 'pe-terraclassic' ) . '</p></div>';

			} else if ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be updated.', 'pe-terraclassic' ) . '</p></div>';

			} else if ( $message == 'deleted' ) {

				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts have been deleted.', 'pe-terraclassic' ) . '</p></div>';

			}

		} else if ( $updated == 'layout' ) {

			return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layout activated.', 'pe-terraclassic' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
	...
	function ot_option_types_array() {
		...
		return apply_filters( 'ot_option_types_array', array(
			'background'                => __( 'Background', 'pe-terraclassic' ),
			'border'                    => __( 'Border', 'pe-terraclassic' ),
			'box-shadow'                => __( 'Box Shadow', 'pe-terraclassic' ),
			'category-checkbox'         => __( 'Category Checkbox', 'pe-terraclassic' ),
			'category-select'           => __( 'Category Select', 'pe-terraclassic' ),
			'checkbox'                  => __( 'Checkbox', 'pe-terraclassic' ),
			'colorpicker'               => __( 'Colorpicker', 'pe-terraclassic' ),
			'colorpicker-opacity'       => __( 'Colorpicker Opacity', 'pe-terraclassic' ),
			'css'                       => __( 'CSS', 'pe-terraclassic' ),
			'custom-post-type-checkbox' => __( 'Custom Post Type Checkbox', 'pe-terraclassic' ),
			'custom-post-type-select'   => __( 'Custom Post Type Select', 'pe-terraclassic' ),
			'date-picker'               => __( 'Date Picker', 'pe-terraclassic' ),
			'date-time-picker'          => __( 'Date Time Picker', 'pe-terraclassic' ),
			'dimension'                 => __( 'Dimension', 'pe-terraclassic' ),
			'gallery'                   => __( 'Gallery', 'pe-terraclassic' ),
			'google-fonts'              => __( 'Google Fonts', 'pe-terraclassic' ),
			'javascript'                => __( 'JavaScript', 'pe-terraclassic' ),
			'link-color'                => __( 'Link Color', 'pe-terraclassic' ),
			'list-item'                 => __( 'List Item', 'pe-terraclassic' ),
			'measurement'               => __( 'Measurement', 'pe-terraclassic' ),
			'numeric-slider'            => __( 'Numeric Slider', 'pe-terraclassic' ),
			'on-off'                    => __( 'On/Off', 'pe-terraclassic' ),
			'page-checkbox'             => __( 'Page Checkbox', 'pe-terraclassic' ),
			'page-select'               => __( 'Page Select', 'pe-terraclassic' ),
			'post-checkbox'             => __( 'Post Checkbox', 'pe-terraclassic' ),
			'post-select'               => __( 'Post Select', 'pe-terraclassic' ),
			'radio'                     => __( 'Radio', 'pe-terraclassic' ),
			'radio-image'               => __( 'Radio Image', 'pe-terraclassic' ),
			'select'                    => __( 'Select', 'pe-terraclassic' ),
			'sidebar-select'            => __( 'Sidebar Select', 'pe-terraclassic' ),
			'slider'                    => __( 'Slider', 'pe-terraclassic' ),
			'social-links'              => __( 'Social Links', 'pe-terraclassic' ),
			'spacing'                   => __( 'Spacing', 'pe-terraclassic' ),
			'tab'                       => __( 'Tab', 'pe-terraclassic' ),
			'tag-checkbox'              => __( 'Tag Checkbox', 'pe-terraclassic' ),
			'tag-select'                => __( 'Tag Select', 'pe-terraclassic' ),
			'taxonomy-checkbox'         => __( 'Taxonomy Checkbox', 'pe-terraclassic' ),
			'taxonomy-select'           => __( 'Taxonomy Select', 'pe-terraclassic' ),
			'text'                      => __( 'Text', 'pe-terraclassic' ),
			'textarea'                  => __( 'Textarea', 'pe-terraclassic' ),
			'textarea-simple'           => __( 'Textarea Simple', 'pe-terraclassic' ),
			'textblock'                 => __( 'Textblock', 'pe-terraclassic' ),
			'textblock-titled'          => __( 'Textblock Titled', 'pe-terraclassic' ),
			'typography'                => __( 'Typography', 'pe-terraclassic' ),
			'upload'                    => __( 'Upload', 'pe-terraclassic' )
		) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
	...
	function ot_radio_images( $field_id = '' ) {
		...
		return apply_filters( 'ot_radio_images', array(
			array(
				'value' => 'left-sidebar',
				'label' => __( 'Left Sidebar', 'pe-terraclassic' ),
				'src'   => OT_URL . 'assets/images/layout/left-sidebar.png'
			),
			array(
				'value' => 'right-sidebar',
				'label' => __( 'Right Sidebar', 'pe-terraclassic' ),
				'src'   => OT_URL . 'assets/images/layout/right-sidebar.png'
			),
			array(
				'value' => 'full-width',
				'label' => __( 'Full Width (no sidebar)', 'pe-terraclassic' ),
...
if ( ! function_exists( 'ot_list_item_settings' ) ) {
	...
	function ot_list_item_settings( $id ) {
		...
		$settings = apply_filters( 'ot_list_item_settings', array(
			array(
				'id'        => 'image',
				'label'     => __( 'Image', 'pe-terraclassic' ),
				'desc'      => '',
				'std'       => '',
				'type'      => 'upload',
				'rows'      => '',
			...
			array(
				'id'        => 'description',
				'label'     => __( 'Description', 'pe-terraclassic' ),
				'desc'      => '',
				'std'       => '',
...
if ( ! function_exists( 'ot_social_links_settings' ) ) {
	...
	function ot_social_links_settings( $id ) {
		...
		$settings = apply_filters( 'ot_social_links_settings', array(
			array(
				'id'    => 'name',
				'label' => __( 'Name', 'pe-terraclassic' ),
				'desc'  => __( 'Enter the name of the social website.', 'pe-terraclassic' ),
				'std'   => '',
				'type'  => 'text',
			...
			array(
				'id'    => 'title',
				'label' => 'Title',
				'desc'  => __( 'Enter the text shown in the title attribute of the link.', 'pe-terraclassic' ),
				'type'  => 'text'
			),
			array(
				'id'    => 'href',
				'label' => 'Link',
				'desc'  => sprintf( __( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'pe-terraclassic' ), '<code>http://</code>' ),
				'type'  => 'text',
			)
		), $id );
	...
	function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
		...
		if ( file_exists( $filepath ) ) {
			...
			if ( ! is_writable( $filepath ) ) {
				add_settings_error( 'pe-terraclassic', 'dynamic_css', sprintf( __( 'Unable to write to file %s.', 'pe-terraclassic' ), '<code>' . $filepath . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_sections_view' ) ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'pe-terraclassic' ) . '">
          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'pe-terraclassic' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'pe-terraclassic' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'pe-terraclassic' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'pe-terraclassic' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . __( 'Add Choice', 'pe-terraclassic' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Settings</strong>: This will only affect the List Item option type.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . __( 'Add Setting', 'pe-terraclassic' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . __( 'and', 'pe-terraclassic' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . __( 'or', 'pe-terraclassic' ) . '</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . __( 'Label', 'pe-terraclassic' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . __( 'Value', 'pe-terraclassic' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . __( 'Image Source (Radio Image only)', 'pe-terraclassic' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . __( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'pe-terraclassic' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
	...
	function ot_layout_view( $key, $data = '', $active_layout = '' ) {
		...
		return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : __( 'Layout', 'pe-terraclassic' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'pe-terraclassic' ) . '">
          <span class="icon ot-icon-square-o"></span>' . __( 'Activate', 'pe-terraclassic' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'pe-terraclassic' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'pe-terraclassic' ) . '
        </a>
...
if ( ! function_exists( 'ot_list_item_view' ) ) {
	...
	function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
		...
		$required_setting = array(
			array(
				'id'        => 'title',
				'label'     => __( 'Title', 'pe-terraclassic' ),
				'desc'      => '',
				'std'       => '',
				'type'      => 'text',
				'rows'      => '',
...
if ( ! function_exists( 'ot_theme_options_layouts_form' ) ) {
	...
	function ot_theme_options_layouts_form( $active = false ) {
		...
		echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . __( 'New Layout', 'pe-terraclassic' ) . '">' . __( 'New Layout', 'pe-terraclassic' ) . '</button>';
...
function ot_fetch_google_fonts( $normalize = true, $force_rebuild = false ) {
	...
	if ( $force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
		...
		$ot_google_fonts_response = wp_safe_remote_get( $ot_google_fonts_query, array(
			'sslverify' => false,
			'timeout'   => 15
		) );
...
function ot_meta_box_post_format_gallery( $pages = 'post' ) {
	...
	return apply_filters( 'ot_meta_box_post_format_gallery', array(
		...
		'title'    => __( 'Gallery', 'pe-terraclassic' ),
		'desc'     => '',
		'pages'    => $pages,
		'context'  => 'side',
		'priority' => 'low',
	...
	return apply_filters( 'ot_meta_box_post_format_link', array(
		...
		'fields'   => array(
			array(
				'id'    => '_format_link_url',
				'label' => '',
				'desc'  => __( 'Link URL', 'pe-terraclassic' ),
				'std'   => '',
				'type'  => 'text'
			),
			array(
				...
				'label' => '',
				'desc'  => __( 'Link Title', 'pe-terraclassic' ),
				'std'   => '',
				'type'  => 'text'
			)
		)
...
function ot_meta_box_post_format_quote( $pages = 'post' ) {
	...
	return apply_filters( 'ot_meta_box_post_format_quote', array(
		...
		'title'    => __( 'Quote', 'pe-terraclassic' ),
		'desc'     => '',
		'pages'    => $pages,
		'context'  => 'side',
		'priority' => 'low',
		'fields'   => array(
			array(
				...
				'label' => '',
				'desc'  => __( 'Source Name (ex. author, singer, actor)', 'pe-terraclassic' ),
				'std'   => '',
				'type'  => 'text'
			),
			array(
				...
				'label' => '',
				'desc'  => __( 'Source URL', 'pe-terraclassic' ),
				'std'   => '',
				'type'  => 'text'
			),
			array(
				...
				'label' => '',
				'desc'  => __( 'Source Title (ex. book, song, movie)', 'pe-terraclassic' ),
				'std'   => '',
				'type'  => 'text'
			),
			array(
				...
				'label' => '',
				'desc'  => __( 'Source Date', 'pe-terraclassic' ),
				'std'   => '',
				'type'  => 'text'
			)
		)
...
function ot_meta_box_post_format_video( $pages = 'post' ) {
	...
	return apply_filters( 'ot_meta_box_post_format_video', array(
		...
		'title'    => __( 'Video', 'pe-terraclassic' ),
		'desc'     => '',
		'pages'    => $pages,
		'context'  => 'side',
		'priority' => 'low',
		'fields'   => array(
			array(
				...
				'label' => '',
				'desc'  => sprintf( __( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'pe-terraclassic' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'pe-terraclassic' ) . '</a>', '<code>[video]</code>' ),
				'std'   => '',
				'type'  => 'textarea'
			)
		)
...
function ot_meta_box_post_format_audio( $pages = 'post' ) {
	...
	return apply_filters( 'ot_meta_box_post_format_audio', array(
		...
		'title'    => __( 'Audio', 'pe-terraclassic' ),
		'desc'     => '',
		'pages'    => $pages,
		'context'  => 'side',
		'priority' => 'low',
		'fields'   => array(
			array(
				...
				'label' => '',
				'desc'  => sprintf( __( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'pe-terraclassic' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'pe-terraclassic' ) . '</a>', '<code>[audio]</code>' ),
				'std'   => '',
				'type'  => 'textarea'
			)
		)
